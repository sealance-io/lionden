...
export class TokenContract extends BaseContract {
  ...
  readonly mint_public = {
    ...
    settled: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("mint_public", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("mint_public", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
  ...
  readonly transfer_public = {
    ...
    settled: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("transfer_public", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("transfer_public", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
  ...
  readonly mint_private = {
    ...
    settled: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>> | RejectedTransition> => {
      ...
      return this.settleTyped("mint_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint_private", 0), deserializeToken));
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>>> => {
      ...
      return this.expectAcceptedTyped("mint_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint_private", 0), deserializeToken));
    },
  ...
  readonly transfer_private = {
    ...
    settled: async (args: { readonly token: Token; readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<[EncryptedRecord<Token>, EncryptedRecord<Token>]> | RejectedTransition> => {
      ...
      return this.settleTyped("transfer_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string) => ([BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "transfer_private", 0), deserializeToken), BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "transfer_private", 1), deserializeToken)] as [EncryptedRecord<Token>, EncryptedRecord<Token>]));
    },
    ...
    accepted: async (args: { readonly token: Token; readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<[EncryptedRecord<Token>, EncryptedRecord<Token>]>> => {
      ...
      return this.expectAcceptedTyped("transfer_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string) => ([BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "transfer_private", 0), deserializeToken), BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "transfer_private", 1), deserializeToken)] as [EncryptedRecord<Token>, EncryptedRecord<Token>]));
    },
