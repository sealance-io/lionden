...
export class Vault extends BaseContract {
  ...
  readonly set_admin = {
    ...
    settled: async (args: { readonly new_admin: AddressInput }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("set_admin", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly new_admin: AddressInput }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("set_admin", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
