...
export class Geo extends BaseContract {
  ...
  readonly get_triangle = {
    ...
    settled: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Triangle>> | RejectedTransition> => {
      ...
      return this.settleTyped("get_triangle", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "geo.aleo", "get_triangle", 0), tpk, "geo.aleo", "get_triangle", 0, (_p: string) => deserializeTriangle(_p)));
    },

    accepted: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Triangle>>> => {
      const _args: string[] = [
      ];
      return this.expectAcceptedTyped("get_triangle", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "geo.aleo", "get_triangle", 0), tpk, "geo.aleo", "get_triangle", 0, (_p: string) => deserializeTriangle(_p)));
    },
  ...
  readonly get_line = {
    ...
    settled: async (args: { readonly triangle: Triangle }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Line>> | RejectedTransition> => {
      ...
      return this.settleTyped("get_line", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "geo.aleo", "get_line", 0), tpk, "geo.aleo", "get_line", 1, (_p: string) => deserializeLine(_p)));
    },
    ...
    accepted: async (args: { readonly triangle: Triangle }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Line>>> => {
      ...
      return this.expectAcceptedTyped("get_line", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "geo.aleo", "get_line", 0), tpk, "geo.aleo", "get_line", 1, (_p: string) => deserializeLine(_p)));
    },
