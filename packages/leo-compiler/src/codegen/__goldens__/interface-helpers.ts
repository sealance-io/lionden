...
export class StableToken extends BaseContract {
  ...
  readonly mint_private = {
    ...
    settled: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>> | RejectedTransition> => {
      ...
      return this.settleTyped("mint_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "stable_token.aleo", "mint_private", 0), deserializeToken));
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>>> => {
      ...
      return this.expectAcceptedTyped("mint_private", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "stable_token.aleo", "mint_private", 0), deserializeToken));
    },
