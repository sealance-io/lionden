...
export class TokenContract extends BaseContract {
  ...
  readonly mint = {
    ...
    settled: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>> | RejectedTransition> => {
      ...
      return this.settleTyped("mint", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint", 0), deserializeToken));
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput; readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>>> => {
      ...
      return this.expectAcceptedTyped("mint", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint", 0), deserializeToken));
    },
  ...
  readonly mint_and_finalize = {
    ...
    settled: async (args: { readonly receiver: AddressInput }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>> | RejectedTransition> => {
      ...
      return this.settleTyped("mint_and_finalize", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint_and_finalize", 0), deserializeToken));
    },
    ...
    accepted: async (args: { readonly receiver: AddressInput }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>>> => {
      ...
      return this.expectAcceptedTyped("mint_and_finalize", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "mint_and_finalize", 0), deserializeToken));
    },
  ...
  readonly split = {
    ...
    settled: async (args: { readonly token: Token }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<[EncryptedRecord<Token>, EncryptedRecord<Token>]> | RejectedTransition> => {
      ...
      return this.settleTyped("split", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => ([BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "split", 0), deserializeToken), BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "split", 1), deserializeToken)] as [EncryptedRecord<Token>, EncryptedRecord<Token>]));
    },
    ...
    accepted: async (args: { readonly token: Token }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<[EncryptedRecord<Token>, EncryptedRecord<Token>]>> => {
      ...
      return this.expectAcceptedTyped("split", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => ([BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "split", 0), deserializeToken), BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "token.aleo", "split", 1), deserializeToken)] as [EncryptedRecord<Token>, EncryptedRecord<Token>]));
    },
