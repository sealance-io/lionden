...
export class Consumer extends BaseContract {
  ...
  readonly get_settings = {
    ...
    settled: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Settings>> | RejectedTransition> => {
      ...
      return this.settleTyped("get_settings", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "consumer.aleo", "get_settings", 0), tpk, "consumer.aleo", "get_settings", 0, (_p: string) => deserializeSettings(_p)));
    },

    accepted: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Settings>>> => {
      const _args: string[] = [
      ];
      return this.expectAcceptedTyped("get_settings", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "consumer.aleo", "get_settings", 0), tpk, "consumer.aleo", "get_settings", 0, (_p: string) => deserializeSettings(_p)));
    },
