...
export class Rewards extends BaseContract {
  ...
  readonly earn_points = {
    ...
    settled: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("earn_points", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("earn_points", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
  ...
  readonly claim_reward = {
    ...
    settled: async (args: { readonly reward_amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("claim_reward", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly reward_amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("claim_reward", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
