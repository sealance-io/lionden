...
export class Hello extends BaseContract {
  ...
  readonly main = {
    ...
    settled: async (args: { readonly a: number; readonly b: number }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<number>> | RejectedTransition> => {
      ...
      return this.settleTyped("main", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "hello.aleo", "main", 0), tpk, "hello.aleo", "main", 2, BaseContract.parseNumber));
    },
    ...
    accepted: async (args: { readonly a: number; readonly b: number }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<number>>> => {
      ...
      return this.expectAcceptedTyped("main", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "hello.aleo", "main", 0), tpk, "hello.aleo", "main", 2, BaseContract.parseNumber));
    },
  ...
  readonly multiply = {
    ...
    settled: async (args: { readonly a: number; readonly b: number }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<number>> | RejectedTransition> => {
      ...
      return this.settleTyped("multiply", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "hello.aleo", "multiply", 0), tpk, "hello.aleo", "multiply", 2, BaseContract.parseNumber));
    },
    ...
    accepted: async (args: { readonly a: number; readonly b: number }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<number>>> => {
      ...
      return this.expectAcceptedTyped("multiply", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "hello.aleo", "multiply", 0), tpk, "hello.aleo", "multiply", 2, BaseContract.parseNumber));
    },
