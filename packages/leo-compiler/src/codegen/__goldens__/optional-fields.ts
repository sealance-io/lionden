...
export class Config extends BaseContract {
  ...
  readonly get_settings = {
    ...
    settled: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Settings>> | RejectedTransition> => {
      ...
      return this.settleTyped("get_settings", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "config.aleo", "get_settings", 0), tpk, "config.aleo", "get_settings", 0, (_p: string) => deserializeSettings(_p)));
    },

    accepted: async (options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<Settings>>> => {
      const _args: string[] = [
      ];
      return this.expectAcceptedTyped("get_settings", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "config.aleo", "get_settings", 0), tpk, "config.aleo", "get_settings", 0, (_p: string) => deserializeSettings(_p)));
    },
  ...
  readonly update = {
    ...
    settled: async (args: { readonly settings: Settings }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("update", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly settings: Settings }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("update", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
