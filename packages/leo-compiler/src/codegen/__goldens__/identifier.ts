...
export class Governance extends BaseContract {
  ...
  readonly route = {
    ...
    settled: async (args: { readonly strategy: IdentifierInput; readonly maybe_strategy: IdentifierInput | null; readonly strategies: ReadonlyArray<IdentifierInput>; readonly vote: Vote }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<LeoIdentifier>> | RejectedTransition> => {
      ...
      return this.settleTyped("route", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "governance.aleo", "route", 0), tpk, "governance.aleo", "route", 4, BaseContract.parseIdentifier));
    },
    ...
    accepted: async (args: { readonly strategy: IdentifierInput; readonly maybe_strategy: IdentifierInput | null; readonly strategies: ReadonlyArray<IdentifierInput>; readonly vote: Vote }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<LeoIdentifier>>> => {
      ...
      return this.expectAcceptedTyped("route", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "governance.aleo", "route", 0), tpk, "governance.aleo", "route", 4, BaseContract.parseIdentifier));
    },
