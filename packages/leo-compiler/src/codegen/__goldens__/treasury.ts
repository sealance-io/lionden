...
export class Treasury extends BaseContract {
  ...
  readonly deposit = {
    ...
    settled: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("deposit", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("deposit", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
  ...
  readonly withdraw = {
    ...
    settled: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("withdraw", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("withdraw", _args, options ?? {}, (_rawOutputs: readonly RawTransitionOutput[], _tpk: string) => undefined as void);
    },
