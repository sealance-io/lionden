...
export class Dex extends BaseContract {
  ...
  readonly add_liquidity = {
    ...
    settled: async (args: { readonly pair_id: FieldInput; readonly amount_a: bigint; readonly amount_b: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<LPToken>> | RejectedTransition> => {
      ...
      return this.settleTyped("add_liquidity", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "add_liquidity", 0), deserializeLPToken));
    },
    ...
    accepted: async (args: { readonly pair_id: FieldInput; readonly amount_a: bigint; readonly amount_b: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<LPToken>>> => {
      ...
      return this.expectAcceptedTyped("add_liquidity", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "add_liquidity", 0), deserializeLPToken));
    },
