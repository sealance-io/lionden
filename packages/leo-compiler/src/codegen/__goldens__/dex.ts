...
export class Dex extends BaseContract {
  ...
  readonly add_liquidity = {
    ...
    settled: async (args: { readonly pair_id: FieldInput; readonly amount_a: bigint; readonly amount_b: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<LPToken>> | RejectedTransition> => {
      ...
      return this.settleTyped("add_liquidity", _args, options ?? {}, (rawOutputs: readonly string[], _tpk: string) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "add_liquidity", 0), deserializeLPToken));
    },
    ...
    accepted: async (args: { readonly pair_id: FieldInput; readonly amount_a: bigint; readonly amount_b: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<LPToken>>> => {
      ...
      return this.expectAcceptedTyped("add_liquidity", _args, options ?? {}, (rawOutputs: readonly string[], _tpk: string) => BaseContract.makeEncryptedRecord(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "add_liquidity", 0), deserializeLPToken));
    },
  ...
  readonly remove_liquidity = {
    ...
    settled: async (args: { readonly lp_token: LPToken }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void> | RejectedTransition> => {
      ...
      return this.settleTyped("remove_liquidity", _args, options ?? {}, (_rawOutputs: readonly string[], _tpk: string) => undefined as void);
    },
    ...
    accepted: async (args: { readonly lp_token: LPToken }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<void>> => {
      ...
      return this.expectAcceptedTyped("remove_liquidity", _args, options ?? {}, (_rawOutputs: readonly string[], _tpk: string) => undefined as void);
    },
  ...
  readonly swap = {
    ...
    settled: async (args: { readonly pair_id: FieldInput; readonly amount_in: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<bigint>> | RejectedTransition> => {
      ...
      return this.settleTyped("swap", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "swap", 0), tpk, "dex.aleo", "swap", 2, BaseContract.parseBigInt));
    },
    ...
    accepted: async (args: { readonly pair_id: FieldInput; readonly amount_in: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedValue<bigint>>> => {
      ...
      return this.expectAcceptedTyped("swap", _args, options ?? {}, (rawOutputs: readonly string[], tpk: string) => BaseContract.makeEncryptedValue(BaseContract.rawOutputAt(rawOutputs, "dex.aleo", "swap", 0), tpk, "dex.aleo", "swap", 2, BaseContract.parseBigInt));
    },
