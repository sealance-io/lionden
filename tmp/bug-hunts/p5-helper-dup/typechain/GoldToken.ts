...
// ---------------------------------------------------------------------------
// GoldToken contract wrapper
// ---------------------------------------------------------------------------

export class GoldToken extends BaseContract {
  constructor(options?: BaseContractOptions) {
    super("gold_token.aleo", options);
  }
  ...
  readonly mint = {
    ...
    settled: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>> | RejectedTransition> => {
      ...
      return this.settleTyped("mint", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord("gold_token.aleo", "Token", BaseContract.rawOutputAt(rawOutputs, "gold_token.aleo", "mint", 0), deserializeToken));
    },
    ...
    accepted: async (args: { readonly amount: bigint }, options?: OnChainExecutionOptions): Promise<AcceptedTransition<EncryptedRecord<Token>>> => {
      ...
      return this.expectAcceptedTyped("mint", _args, options ?? {}, (rawOutputs: readonly RawTransitionOutput[], _tpk: string, _transitions: readonly ConfirmedTransitionRecord[]) => BaseContract.makeEncryptedRecord("gold_token.aleo", "Token", BaseContract.rawOutputAt(rawOutputs, "gold_token.aleo", "mint", 0), deserializeToken));
    },
...
export function createGoldToken(options?: BaseContractOptions): GoldToken {
  return new GoldToken(options);
}
